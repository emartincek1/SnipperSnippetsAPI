...
namespace SnipperSnippetsAPI.Utilities
{
    public class EncryptUtility
    {
        ...
        public EncryptUtility(IConfiguration configuration)
        {
            ...
            Key = Encoding.UTF8.GetBytes(configuration["AES_KEY"] ?? "22199a2ce17b2bcbbe4e280b0af97218");
            IV = Encoding.UTF8.GetBytes(configuration["AES_IV"] ?? "f38f89759ae6da84");
        }
